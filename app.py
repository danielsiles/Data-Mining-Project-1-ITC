...
def assigning_args(args):
    ...
    return driver,create_db,league,match,stat,scrape_all,date,seed,populate
...
def main():
    ...
    try:
        ...
        driver,create_db,league,match,stat,scrape_all,date,seed,populate = assigning_args(args)
